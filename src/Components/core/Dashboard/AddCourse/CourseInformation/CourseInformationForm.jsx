...
const CourseInformationForm = () => {
 ...
 const getCategories = async () => {
  ...
  console.log("Fetched categories:", cat); // 👈 Check this!

  if (!Array.isArray(cat)) {
    toast.error("Invalid category data");
  } else if (cat.length === 0) {
    toast.error("No course categories available."); // 👈 You’re seeing this
  } else {
...
console.log("Selected category ID:", getValues("courseCategory"));
