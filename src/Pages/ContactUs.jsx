    ...
    <div>
        ...
        <div className='lg:w-[40%]'>
            <div className='flex flex-col gap-6 rounded-xl bg-richblack-800 p-4 lg:p-6'>
                <div className='flex flex-col gap-[2px] p-3 text-sm text-richblack-200'>
                    ...
                    <p className='font-medium'>Our chess support team is ready to assist you.</p>
                    <p className='font-semibold'>support@chessmentor.com</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                    ...
                    <p className='font-medium'>Drop by our chess lab HQ anytime.</p>
                    <p className='font-semibold'>Kings Square, Game Avenue, Chess City - 560016</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                ...
                <p className='font-medium'>Mon - Fri | 10 AM - 6 PM IST</p>
        ...
        <div className='lg:w-[60%]'>
            <div className='border border-richblack-600 text-richblack-300 rounded-xl p-7 lg:p-14 flex gap-3 flex-col'>
                ...
                Got a chess idea? Let’s build your winning strategy
                </h1>
                <p className='text-lg font-medium'>Tell us how we can bring your chess concept to life with AI and mentorship.</p>
                <div className='mt-7'>
                    <ContactUsForm/>
                </div>
            </div>
        ...
        <div className='relative mx-auto my-20 flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-white'>
                    <h1 className='text-center text-4xl font-semibold mt-8'>
                        Learner Reviews from the Chess Board
                    </h1>
                </div>
    </div>
  )
